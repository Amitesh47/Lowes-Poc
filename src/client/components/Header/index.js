...
import { Nav, Logo, Search, Cart,FullSearchInput, SearchLabel } from './styles';
        ...
        <Nav data-test="getHeader">
            <Container>
                <Row>
                    ...
                    <Col xs={3} sm={3} lg={{ span: 2, offset: 2 }}><FullSearchInput><SearchLabel> Search<Search type="text" data-test="getSearch"  /></SearchLabel></FullSearchInput></Col>
